...
def export(context, *, filepath, ExportAnimations=True, ExportSDFOnly=False, face_plane_mode="CURRENT"):
    '''
    ...
    SDFC.ddr = int(context.scene.SDFVDFPropertyGroup.Defensive)
    SDFC.defensive = SDFC.ddr
