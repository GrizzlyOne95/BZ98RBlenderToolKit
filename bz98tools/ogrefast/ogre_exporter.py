...
def _collect_vertex_bone_assignments(operator, mesh_data, ob, mesh, renormalize_weights):
    bone_assignments = []
...
def collect_mesh(
    ...
    for submesh_index, ob in enumerate(selected_objects):
        ...
        tangent_dimensions = 4 if submesh_tangent_format == 'TANGENT_4' or submesh_tangent_format == 'ALL' or submesh_tangent_format == 'FLIPPED' else 3
        if submesh_tangent_format != 'TANGENT_0':
