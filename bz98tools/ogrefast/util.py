...
def load_translate() -> Dict[str, Dict[Tuple[str, str], str]]:
    translation_dict = {
        "en_US": {
            ...
            (
                "*",
                "Import vertex normals (split normals)",
            ): "Import vertex normals (split normals)",
            ("*", "Import animation"): "Import animation",
            (
                "*",
                "Import skeletal animations as actions",
            ): "Import skeletal animations as actions",
            ("*", "Adjust frame rate"): "Adjust frame rate",
            (
                "*",
                "Adjust scene frame rate to match imported animation",
            ): "Adjust scene frame rate to match imported animation",
...
Weightmaps can get mixed up if not selected""",
            ...
            (
                "*",
                "If characters are not displayed correctly, try changing the character code",
            ): "If characters are not displayed correctly, try changing the character code",
            ("*", "Mesh version"): "Mesh version",
            (
                "*",
                "The latest version that supports Kenshi",
            ): "The latest version that supports Kenshi",
            (
                "*",
                "Particle Universe Editor compatible version",
            ): "Particle Universe Editor compatible version",
            (
                "*",
                "Scythe Physics Editor compatible version",
            ): "Scythe Physics Editor compatible version",
            ...
            (
                "*",
                "tangent & binormal(flip) & sign(flip)",
            ): "tangent & binormal(flip) & sign(flip)",
            (
                "*",
            ...
            (
                "*",
                "Applies object's transformation to its data",
            ): "Applies object's transformation to its data",
            ...
            (
                "*",
                "Export all actions attached to the selected skeleton as animations",
            ): "Export all actions attached to the selected skeleton as animations",
            (
                "*",
                "Include bones with undefined IDs",
            ): "Include bones with undefined IDs",
            (
                "*",
            ...
            (
                "*",
                "Export all collision objects in the scene",
            ): "Export all collision objects in the scene",
            ("*", "Selection"): "Selection",
            ...
            (
                "*",
                "Export selected objects and all their child objects",
            ): "Export selected objects and all their child objects",
            ("*", "Transform"): "Transform",
            ("*", "Scene"): "Scene",
            (
                "*",
                "Export objects relative to scene origin",
            ): "Export objects relative to scene origin",
            ("*", "Coomon Parent"): "Common Parent",
            (
                "*",
                "Export objects relative to common parent",
            ): "Export objects relative to common parent",
            ("*", "Active"): "Active",
            (
                "*",
                "Export objects relative to the active object",
            ): "Export objects relative to the active object",
            ("*", "Parent"): "Parent",
            (
                "*",
                "Export objects relative to own parent",
            ): "Export objects relative to own parent",
            (
                "*",
                "Link animation to selected armature object",
            ): "Link animation to selected armature object",
            ("*", "Skeleton version"): "Skeleton version",
            (
                "*",
                "Determine mesh name from file name",
            ): "Determine mesh name from file name",
            (
                "*",
                "mesh name will be 'filename_number'",
            ): "mesh name will be 'filename_number'",
            (
                "*",
                "Failed to decode submesh name, replaced with default name.",
            ): "Failed to decode submesh name, replaced with default name.",
            (
                "*",
                "Failed to decode material name, replaced with default name.",
            ): "Failed to decode material name, replaced with default name.",
            (
                "*",
            ...
            (
                "*",
                "Set scale keyframes in the animation",
            ): "Set scale keyframes in the animation",
...
so it's a good idea to pre-bake the animation and uncheck this option""",
            (
                "*",
                "Canceled because 'use selected armature' A is enabled and 'Import animation' is disabled",
            ): "Canceled because 'use selected armature' A is enabled and 'Import animation' is disabled",
            ...
            (
                "*",
                "Keep the face as much as possible",
            ): "Keep the face as much as possible",
            (
                "*",
                "Merges vertices as much as possible, but double-sided polygons become single-sided",
            ): "Merges vertices as much as possible, but double-sided polygons become single-sided",
            (
                "*",
                "Keeps all vertices but separates faces",
            ): "Keeps all vertices but separates faces",
        },
        "ja_JP": {
            ...
            (
                "*",
                "Import skeletal animations as actions",
            ): "スケルタルアニメーションをアクションとしてインポートします",
            ("*", "Adjust frame rate"): "フレームレートを調整",
            (
                "*",
                "Adjust scene frame rate to match imported animation",
            ): "インポートしたアニメーションに合わせてシーンのフレームレートを調整します",
            ("*", "Import shape keys"): "シェイプキーをインポート",
            (
                "*",
                "Import shape keys (morphs)",
            ): "シェイプキー(モーフ)をインポートします",
...
選択されていないと、ウェイトマップが混同される可能性があります""",
            ...
            (
                "*",
                "If characters are not displayed correctly, try changing the character code",
            ): "文字が正常に表示されない場合は、文字コードを変更してみてください",
            ("*", "Mesh version"): "メッシュバージョン",
            (
                "*",
                "The latest version that supports Kenshi",
            ): "Kenshi に対応している最新のバージョン",
            (
                "*",
                "Particle Universe Editor compatible version",
            ): "Particle Universe Editor 互換バージョン",
            (
                "*",
                "Scythe Physics Editor compatible version",
            ): "Scythe Physics Editor 互換バージョン",
            ...
            (
                "*",
                "Export tangent and binormal's signs and binormal (before multiplying by sign).\nCompatible with most shaders",
            ): "接線と従法線の符号と従法線(符号乗算前)をエクスポートします\nほとんどのシェーダーと互換性があります",
            ("*", "tangent & sign"): "接線と符号",
            (
                "*",
                "Export tangent and binormal's signs.\nCompute the binormals at runtime.\nFor weapons, buildings, etc",
            ...
            (
                "*",
                "Applies object's transformation to its data",
            ): "オブジェクトのトランスフォームを適用します",
            ("*", "Apply Modifiers"): "モディファイアを適用",
            (
                "*",
                "Applies modifiers to the mesh",
            ): "メッシュのモディファイアを適用します",
            ("*", "Export shape keys"): "シェイプキーをエクスポート",
            (
                "*",
                "Export shape keys as poses",
            ): "シェイプキーをポーズとしてエクスポートします",
            ...
            (
                "*",
                "Export all actions attached to the selected skeleton as animations",
            ): "選択したスケルトンにアタッチされているすべてのアクションをアニメーションとしてエクスポートします",
            ...
            (
                "*",
                "Export all collision objects in the scene",
            ): "シーン内のすべてのコリジョンオブジェクトをエクスポートします",
            ("*", "Selection"): "選択",
            (
                "*",
            ...
            (
                "*",
                "Export selected objects and all their child objects",
            ): "選択したオブジェクトとそのすべての子オブジェクトをエクスポートします",
            ("*", "Transform"): "トランスフォーム",
            ("*", "Scene"): "シーン",
            (
                "*",
                "Export objects relative to scene origin",
            ): "シーンの原点を基準にオブジェクトをエクスポートします",
            ("*", "Common Parent"): "共通ペアレント",
            (
                "*",
                "Export objects relative to common parent",
            ): "共通のペアレントを基準にオブジェクトをエクスポートします",
            ("*", "Active"): "アクティブ",
            (
                "*",
                "Export objects relative to the active object",
            ): "アクティブなオブジェクトを基準にオブジェクトをエクスポートします",
            ("*", "Parent"): "ペアレント",
            (
                "*",
                "Export objects relative to parent",
            ): "ペアレントを基準にオブジェクトをエクスポートします",
            (
                "*",
                "Link animation to selected armature object",
            ): "選択したアーマチュアオブジェクトにアニメーションをリンクします",
            ...
            (
                "*",
                "mesh name will be 'filename_number'",
            ): "メッシュ名が「ファイル名_番号」になります",
            (
                "*",
                "Failed to decode submesh name, replaced with default name.",
            ): "メッシュ名のデコードに失敗したので、デフォルト名に置き換えました",
            (
                "*",
                "Failed to decode material name, replaced with default name.",
            ): "マテリアル名のデコードに失敗したので、デフォルト名に置き換えました",
            (
                "*",
                "Selected armature has no OGRE data",
            ): "選択したアーマチュアにはOGREデータがありません",
            (
                "*",
                "Failed to load linked skeleton",
            ): "リンクされたスケルトンの読み込みに失敗しました",
            (
                "*",
                "No objects selected for export",
            ): "エクスポートするオブジェクトが選択されていません",
...
事前にアニメーションをベイクしてこのオプションをオフにすることをお勧めします""",
            (
                "*",
                "Canceled because 'use selected armature' A is enabled and 'Import animation' is disabled",
            ): "「選択したアーマチュアを使用」が有効で「アニメーションをインポート」が無効になっているため、キャンセルされました",
